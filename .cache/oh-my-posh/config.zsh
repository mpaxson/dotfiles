export POSH_THEME=$'/home/kettle/.cache/oh-my-posh/themes/{theme}.omp.json'
export POSH_SHELL='zsh'
export POSH_SHELL_VERSION=$ZSH_VERSION
export POSH_SESSION_ID=$'260f6fd6-85ce-4229-a615-637a428506a2'
...
_omp_executable=$'/home/kettle/dotfiles/bin/oh-my-posh'
