...
Example: "What was decided in `#dev-team` about the migration timeline?" -- The AI searches the channel, reads the relevant thread, and gives you a synthesized answer, all without you leaving your current chat.
...
**Privacy warning**: Public channels are visible to all users on your instance. Do not share API keys, passwords, or sensitive data in public channels.
