# Save Web Search Results to Knowledge

The **Add Web Sources to Knowledge Action** saves web search result URLs directly to a Knowledge Base with a single click, automating the fetching, sanitizing, and uploading of web content.
...
The feature is implemented as a **Function Action**. To use it:
