# Speech-to-Text - Mistral Voxtral Integration
...
Voxtral accepts common audio formats. The system defaults to accepting `audio/*` and `video/webm`. If using the chat completions method, audio is automatically converted to mp3.
...
| **Model Options** | voxtral-mini-latest | whisper-1 | tiny to large |
