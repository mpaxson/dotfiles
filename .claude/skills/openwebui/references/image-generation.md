...
If your model is configured with **Native Function Calling**, it can invoke image generation directly as a tool.
...
**Legacy "Generate Image" Button:** As of Open WebUI v0.7.0, the native "Generate Image" button (which allowed generating an image directly from a message's content) was removed. If you wish to restore this functionality, you can use the community-built **[Generate Image Action](https://openwebui.com/posts/3fadc3ca-c955-4c9e-9582-7438f0911b62)**.
