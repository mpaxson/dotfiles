...
### Theme Overrides and Analytics

For theme overrides (`custom_dir`) and analytics/consent TOML conversion, see [migration-status.md](migration-status.md).
...
For key differences, theme variants, feature parity status, and CI publishing changes, see [migration-status.md](migration-status.md).
